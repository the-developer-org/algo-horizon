...
export async function GET() {
  ...
  const authUrl = `${process.env.NEXT_PUBLIC_UPSTOX_API_URL}/login/authorization/dialog?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=code&state=${state}`
