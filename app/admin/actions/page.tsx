      ...
      <Card className="bg-gray-800 border-gray-700 p-6">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <Button
            ...
            className={isSelectAll ? "bg-green-600 hover:bg-green-700" : "border-gray-600 text-gray-900 hover:bg-gray-700"}
          >
            {isSelectAll ? "Deselect All" : "Select All"}
          </Button>
          
          <div className="flex items-center gap-2">
            <Label className="text-gray-900">Timeframe:</Label>
            <Select value={timeframeYears} onValueChange={setTimeframeYears}>
              <SelectTrigger className="w-32 bg-gray-600 border-gray-600 text-white">
